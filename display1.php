...
if (isset($_POST['name'])) {
    ...
    if ($_POST['name'] == "" || $_POST['email'] == "" || $_POST['phone'] == "" || $_POST['age'] == "") {
        $err = "<h2>All filds are requered</h2>";
    } else {
        $server = "localhost";
        $username = "root";
        $password = "";
            ...
            <div class="subright">
                ...
                <form action="display1.php" method="post" class="px-5">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="phone" id="name" aria-describedby="emailHelp" >
                    </div>
                    <div class="mb-3">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><a href="update.php?sno=<?php echo $fetch['sno'] ?>">Edit</a></td>
                </tr>
            <?php
            }
            ?>
